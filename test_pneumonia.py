...
print("Model testing for pneumonia dataset")
...
model_path = os.path.join("Model_weights","Pneumonia_CNN_model.pth")
...
#resutls
print("Results for Pneumonia test dataset with CNN model")
...
binary_confusion_metrics(predictions=c_test_predictions,
                         target=c_test_targets,
                         fig_name="Test_pneumonia_CNN_confusion_matrix")
...
r_model_path = os.path.join("Model_weights","Pneumonia_ResNet50_model.pth")
...
print(f"Pneumonia test data classes for ResNet: {r_test_data.class_to_idx}")
print(f"Pneumonia test data size for ResNet : {len(r_test_data)}")
...
binary_confusion_metrics(predictions=r_test_predictions,
                         target=r_test_targets,
                         fig_name="Test_pneumonia_ResNet_confusion_matrix")
